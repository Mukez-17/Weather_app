...
function WeatherApp() {
    ...
    const search = async() => {
        ...
        temp[0].innerHTML = Math.floor(data.main.temp) + " &#176C";
  ...
  return (
    <div className="container">
        ...
        <div className="weather_location">Madurai</div>
        <div className="data_container">
            <div className="element">
                <img src={humidity_icon} alt="" className="icon" />
                <div className="data">
                    <div className="humidity_percent">60%</div>
            ...
            <div className="element">
                ...
                <div className="data">
                    <div className="wind_rate">20km/h</div>
